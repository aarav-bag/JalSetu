import { TestTube, Droplet, Scale, Thermometer, ArrowRight, CheckCircle2, AlertTriangle, XCircle, ShieldCheck, PlugZap } from "lucide-react";
          ...
          <div className="flex flex-col items-center justify-center py-6 gap-3">
            ...
            <div className="text-center">
              ...
              <p className="text-xs card-muted mt-1 leading-relaxed">
                Real data will appear here once your<br />ESP32 sends its first reading.
              </p>
            </div>
          </div>
        ) : (
